...
namespace GiantGrey.TileWorldCreator.UI
{
    public class BlueprintLayerPopupSelector : PopupWindowContent
    {
        ...
        public static bool multiSelect = true;
        ...
        public static void ShowPanel(Vector2 _pos, Configuration _configuration, ref List<string> _assignedBlueprintLayerGuids, ref List<string> _assignedBlueprintLayerNames, BlueprintLayerPopupSelector _panel, Action _onSelected, bool _multiSelect = true)
        {
            position = _pos;
        ...
        void RefreshScrollView()
        {
            ...
            foreach (var _layer in _layers)
            {
                ...
                _item.RegisterCallback<ClickEvent>(evt =>
                {
                    ...
                    {
                        assignedBlueprintLayerGuids.Clear();
                        assignedBlueprintLayerNames.Clear();

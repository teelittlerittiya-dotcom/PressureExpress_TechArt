...
namespace GiantGrey.TileWorldCreator.UI
{
    ...
    public class LabelGizmoDrawer
    {
        ...
        static void OnSceneGUI(SceneView sceneView)
        {
            ...
            foreach (LayerIdentifier _layerIdentifier in Object.FindObjectsByType<LayerIdentifier>(findObjectsInactive: FindObjectsInactive.Include))
#elif UNITY_6000_0_OR_NEWER
            foreach (LayerIdentifier _layerIdentifier in GameObject.FindObjectsByType<LayerIdentifier>(sortMode: FindObjectsSortMode.None))
#else
...
#endif
            {
                ...
                if (_layer.tileLayers == null)
                    ...
                    if (isDragging && GUIUtility.hotControl != activeHandleID && Event.current.type == EventType.Layout)
                    {
                        ...
                        isDragging = false;
#if UNITY_6000_5_OR_NEWER
                        foreach (LayerIdentifier _li in Object.FindObjectsByType<LayerIdentifier>(findObjectsInactive: FindObjectsInactive.Include))
#elif UNITY_6000_0_OR_NEWER
                        foreach (LayerIdentifier _li in GameObject.FindObjectsByType<LayerIdentifier>(findObjectsInactive: FindObjectsInactive.Include, FindObjectsSortMode.None))
#else

...
namespace GiantGrey.TileWorldCreator
{
    ...
    public class BuildLayer : ScriptableObject
    {
        ...
        [BlueprintLayer("Blueprint Layer")]
        ...
        public struct TileData : IEquatable<TileData>
        {
            ...
            public Vector2[] contributingCells;
        ...
        [System.NonSerialized] public bool isLateExecuting;
        ...
        public virtual void ExecuteLayer(Configuration _configuration, GameObject _owner, TileWorldCreatorManager _manager, HashSet<int> _affectedClusters = null) {}
        public virtual void PostExecuteLayer(Configuration _configuration, GameObject _owner, TileWorldCreatorManager _manager) {}

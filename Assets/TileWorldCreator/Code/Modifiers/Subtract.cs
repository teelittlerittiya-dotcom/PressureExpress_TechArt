...
namespace GiantGrey.TileWorldCreator
{
    ...
    public class Subtract : BlueprintModifier
    {
        ...
        public override VisualElement BuildInspector(Configuration _asset)
        {
            ...
            {
                BlueprintLayerPopupSelector.ShowPanel(Event.current.mousePosition, _asset, ref assignedBlueprintLayerGuids, ref assignedBlueprintLayerNames, new BlueprintLayerPopupSelector(), () => _selectBlueprint.value = string.Join(", ", assignedBlueprintLayerNames), true);
            });
